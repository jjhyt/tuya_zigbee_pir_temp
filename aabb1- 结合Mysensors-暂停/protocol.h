...
#define PRODUCT_KEY "mq62o5ur"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//当前亮度值(只上报)
//备注:
#define DPID_BRIGHT_VALUE 6
//当前温度(只上报)
//备注:
#define DPID_TEMP_CURRENT 7
//当前湿度(只上报)
//备注:
#define DPID_HUMIDITY_VALUE 8
//PIR 灵敏度(可下发可上报)
//备注:
#define DPID_PIR_SENSITIVITY 9
//有人保持时间(可下发可上报)
//备注:
#define DPID_PIR_TIME 10
